...
const styles = StyleSheet.create({
  ...
  phonePrefix: { color: colors.primaryDeepest, fontSize: 14, fontWeight: "700" },
  input: { flex: 1, paddingHorizontal: spacing.md, paddingVertical: 8, color: colors.primaryDeepest, fontSize: 14 },
  applyCard: {
    borderRadius: 16,
  ...
  secondaryButtonText: { color: colors.primaryDeepest, fontSize: 14, fontWeight: "700" },
  primaryButton: {
    minHeight: 48,
    borderRadius: 14,
