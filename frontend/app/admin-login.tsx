...
const styles = StyleSheet.create({
  ...
  phonePrefix: { color: colors.primaryDeepest, fontSize: 14, fontWeight: "800", marginRight: spacing.sm },
  input: { flex: 1, paddingVertical: 8, color: colors.primaryDeepest, fontSize: 14 },
  errorBanner: {
    flexDirection: "row",
